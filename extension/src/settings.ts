...
import type { BackgroundRequest, BackgroundResponse, BruhExport, SideberryExport, Snapshot, UiNode, UiStateForRender, UserConfig } from './types';
...
class SettingsPage {
    ...
    constructor() {
        ...
        browser.windows.getCurrent().then(win => {
            this.currentWindowId = win.id as any;
        });
